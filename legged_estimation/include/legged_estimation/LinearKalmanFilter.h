...
private:
  Eigen::Matrix<scalar_t, 30, 1> xHat_;
  Eigen::Matrix<scalar_t, 12, 1> ps_;
  Eigen::Matrix<scalar_t, 12, 1> vs_;
  Eigen::Matrix<scalar_t, 30, 30> a_;
  Eigen::Matrix<scalar_t, 30, 30> q_;
  Eigen::Matrix<scalar_t, 30, 30> p_;
  Eigen::Matrix<scalar_t, 56, 56> r_;
  Eigen::Matrix<scalar_t, 30, 3> b_;
  Eigen::Matrix<scalar_t, 56, 30> c_;
